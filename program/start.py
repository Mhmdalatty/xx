        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("👨🏻‍💻 مبرمج السورس 👨🏻‍💻 ", url=f"https://t.me/TTTLL0"),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("‹ 𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 ›", url=f"https://t.me/TTTLL0"),
            ],
            [
                InlineKeyboardButton(
...
async def Rio(c: Client, message: Message):
    ...
    await m_reply.edit_text(f"**تفضل كروب الدعم انضم لتلقي المساعده**\n`{GROUP_SUPPORT}`")
